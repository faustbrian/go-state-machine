...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-state-machine" &&
                "${module_path}" != github.com/faustbrian/go-state-machine/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-state-machine"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
